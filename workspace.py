...
if __name__ == '__main__':
    ...
    print("server_split_ratio:",server_split_ratio)
    train_set, test_set = create_data()
    client_data_sets,server_data = split_clients_server_data(train_set,server_split_ratio)
    clients,clients_ids = create_clients(client_data_sets,server_data,test_set,server_split_ratio)
    server = Server(id_ = "server", global_data=server_data, test_set=test_set, server_split_ratio=server_split_ratio, clients_ids=clients_ids)
