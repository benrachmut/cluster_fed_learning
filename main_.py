...
if __name__ == '__main__':
    print(device)
    seed_num_list = [2,4,5,6,9]#[2,4,6,8,9]#[1,3,5,7]#[1,2,3,4,5,6,7,8,9]
    ...
    algorithm_selection_list =[AlgorithmSelected.NoFederatedLearning]#, AlgorithmSelected.NoFederatedLearning, AlgorithmSelected.pFedCK]#, AlgorithmSelected.NoFederatedLearning, AlgorithmSelected.pFedCK]#,AlgorithmSelected.PseudoLabelsClusters]
