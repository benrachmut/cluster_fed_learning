...
if __name__ == '__main__':
    ...
    algorithm_selection_list =[AlgorithmSelected.FedAvg]#, AlgorithmSelected.NoFederatedLearning, AlgorithmSelected.pFedCK]#, AlgorithmSelected.NoFederatedLearning, AlgorithmSelected.pFedCK]#,AlgorithmSelected.PseudoLabelsClusters]
