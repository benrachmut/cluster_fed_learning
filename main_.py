...
if __name__ == '__main__':
    ...
    algorithm_selection_list =[AlgorithmSelected.COMET]#[AlgorithmSelected.FedMD,AlgorithmSelected.pFedCK,AlgorithmSelected.COMET,AlgorithmSelected.Ditto, AlgorithmSelected.FedAvg,AlgorithmSelected.FedBABU]
