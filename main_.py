...
if __name__ == '__main__':
    ...
    for data_type in data_types:
        ...
        clients_train_data_dict, server_train_data, clients_test_data_dict, server_test_data,identical_groups = create_data(data_type)

        for num_cluster in num_cluster_list:
            if num_cluster == 6 and data_type == DataType.IID:
                continue
            else:
                ...
                for net_type in nets_types_list:
                    ...
                    for cluster_technique in cluster_technique_list:
                        ...
                        for server_feedback_technique in server_feedback_technique_list:
                            ...
                            server = Server(id_="server",global_data=server_train_data,test_data = server_test_data,clients_ids = clients_ids,clients_test_data_dict = clients_test_data_dict,identical_groups = identical_groups)
