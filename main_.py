...
if __name__ == '__main__':
    ...
    cluster_additions = [0]#[-4,-3,-2,-1,1,2]#,-3,-1,1,2,3,4]  # 0.96,0.5,0.75,1,1.25,1.5,1.75,2]
    print("epsilons:", cluster_additions)
    print(("alpha_dichts", alpha_dichts))
    algorithm_selection_list = [AlgorithmSelected.NoFederatedLearning]#[AlgorithmSelected.PseudoLabelsNoServerModel,AlgorithmSelected.NoFederatedLearning,AlgorithmSelected.pFedCK,AlgorithmSelected.FedAvg]#[AlgorithmSelected.PseudoLabelsClusters]
    ...
    nets_types_list_PseudoLabelsClusters  = [NetsType.C_alex_S_vgg,NetsType.C_alex_S_alex]#,NetsType.C_alex_S_vgg]# ,NetsType.C_alex_S_vgg]#,NetsType.C_alex_S_vgg]#,NetsType.C_alex_S_vgg]
