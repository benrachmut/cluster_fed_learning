...
if __name__ == '__main__':
    ...
    mix_percentage = 0.1
    server_amount_data_list = [1]#[0.25,0.5,0.75,1]
    ...
    nets_types_list_PseudoLabelsClusters  = [NetsType.C_MobileNet_S_alex]#[NetsType.C_rnd_S_vgg,NetsType.C_alex_S_alex,NetsType.C_MobileNet_S_alex,NetsType.C_MobileNet_S_vgg,NetsType.C_alex_S_vgg]#,NetsType.C_alex_S_vgg,NetsType.C_alex_S_alex]#,NetsType.C_alex_S_vgg]# ,NetsType.C_alex_S_vgg]#,NetsType.C_alex_S_vgg]#,NetsType.C_alex_S_vgg]
