...
if __name__ == '__main__':
    ...
    cluster_technique_list = [ClusterTechnique.greedy_elimination_cross_entropy]#[ClusterTechnique.manual_single_iter,ClusterTechnique.manual,ClusterTechnique.kmeans]
    server_feedback_technique_list = [ServerFeedbackTechnique.similar_to_client,ServerFeedbackTechnique.similar_to_cluster]#[ServerFeedbackTechnique.similar_to_cluster,ServerFeedbackTechnique.similar_to_client]
    num_cluster_list = [5]
