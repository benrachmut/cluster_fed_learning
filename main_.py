...
if __name__ == '__main__':
    ...
    for data_type in data_types:
        ...
        for num_clients in num_clients_list:
            ...
            data_to_pickle[data_type.name][num_clients] = {}
            for mix_percentage in mix_percentage_list:
                ...
                data_to_pickle[data_type.name][num_clients][mix_percentage_name] = {}
                ...
                for net_type in nets_types_list:
                    ...
                    data_to_pickle[data_type.name][num_clients][mix_percentage_name][net_type.name] = {}

                    for net_cluster_technique in net_cluster_technique_list:
                        experiment_config.net_cluster_technique = net_cluster_technique
                        data_to_pickle[data_type.name][num_clients] [mix_percentage_name][net_type.name][net_cluster_technique.name]={}
                        ...
                        for num_cluster in num_cluster_list:
                            if num_cluster == "known_labels" and data_type == DataType.IID:
                                ...
                                data_to_pickle[data_type.name][num_clients] [mix_percentage_name][net_type.name][net_cluster_technique.name][num_cluster] = {}
                            ...
                            for server_input_tech in server_input_tech_list:
                                ...
                                data_to_pickle[data_type.name][num_clients] [mix_percentage_name][net_type.name][net_cluster_technique.name][num_cluster][server_input_tech.name] = {}

                                for cluster_technique in cluster_technique_list:
                                    experiment_config.cluster_technique = cluster_technique
                                    data_to_pickle[data_type.name][num_clients] [mix_percentage_name][net_type.name][net_cluster_technique.name][num_cluster][server_input_tech.name][cluster_technique.name] = {}
                                    ...
                                    for server_feedback_technique in server_feedback_technique_list:
                                        ...
                                        for t in range(experiment_config.iterations):
                                            ...
                                            pik_name = data_type.name+"_"+str(num_clients)+"_"+mix_percentage_name+"_"+net_type.name+"_"+str(num_cluster)+"_"+net_cluster_technique.name+"_"+server_input_tech.name+"_"+cluster_technique.name +"_"+server_feedback_technique.name
